...
$query="SELECT ename,slno, `edesc`, `edate`,Location, `file_loc`,`golive`,`creator`,`type1`,`emailbox`  FROM `event` WHERE slno=$event_id";
...
$emailbox=$rows3[9];
 ...
 $assoc_name="Prapul";
	...
	$arr['eimage']=$eimage;
	$arr['emailbox']=$emailbox;


 template_outside($arr);
 
 send_mail_outside($emailbox,$emailaddress,$event_name,$event_id);
            ...
            <tr style="vertical-align: top;" valign="top">
                <td style="word-break: break-word; vertical-align: top;" valign="top">
                    ...
                    <div style="background-color:transparent;">
                        <div class="block-grid" style="Margin: 0 auto; min-width: 400px; max-width: 700px; overflow-wrap: break-word; word-wrap: break-word; word-break: break-word; background-color: #ffffff;">
...
<?php 
function send_mail_outside($from,$emailaddress,$event_name,$event_id)
{
 ...
 // $mail->addCC($manager_email);
  ...
  $mail->msgHTML(file_get_contents('template10.html'), dirname(__FILE__));
  ...
  { 
    ...
    header("location:external_mail.php?event_id=$event_id&exist1='mail_sent_successfully'");
  }
