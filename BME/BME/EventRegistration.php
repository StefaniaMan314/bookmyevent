    ...
    $vall=$rows2[0];
      $total=$tim;
                   $availwait =$rows3[0];                             ?> &nbsp;
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="associateName"
                                                        placeholder="Associate Lastname, Firstname">
                                                </div>
                                                <br>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-primary" 
                                                onclick="alertify
                                                    .confirm(
                                                        'Please Confirm:', 
                                                        'You are trying to register for <?php $d1= new DateTime( $start_date); echo $d1->format(' M d Y - h:i a'); ?> batch', 
                                                        function(){ window.location='TimeslotDependent.php?time=<?php echo $arr[0]; ?>&event_id=<?php echo $event_id; ?>&arrayOfDependentsLength=<?php echo 2; ?>&arrayOfDependentLastNames=<?php echo 'Last1, Last2'; ?>&arrayOfDependentFirstNames=<?php echo 'First1, First2'; ?>'},
                                                        function(){ }
                                                    );">Submit</button>
                                        </div>
                                    </div>
                            ...
                            <!-- <a class='btn btn-sm btn-success' onclick="alertify.confirm('Please Confirm:', 'You are trying to register for <?php $d1= new DateTime( $start_date); echo $d1->format(' M d Y - h:i a'); ?> batch', function(){ window.location='timeslot.php?time=<?php echo $arr[0]; ?>&event_id=<?php echo $event_id; ?>'} -->
                <!-- , function(){ });">
                                Register
                            </a>  -->
                            &nbsp;&nbsp;
