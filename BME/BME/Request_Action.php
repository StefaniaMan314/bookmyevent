            ...
            <?php if(isset($error)) { ?>
                ...
                <?php } ?>
                    ...
                    <div class="card">
					  <div class='row'>
                            <div class='col-lg-12'>
                                <h3 style='color:#0D94D2;font-size:20px'> &nbsp; Pending  Access Requests</h3> </div>
                        </div>
...
$query="SELECT * FROM `bme_access` WHERE status='0' AND action_by=''";
...
$slno=$arr['slno'];
   ...
   //location.href='RejectAccess.php?slno=<?php echo $slno; ?>
                                                                                        <tr>
																						<td> <a class="btn btn-default bg-olive" onclick="location.href='scripts/approve_access.php?slno=<?php echo $slno; ?>'" > Approve </a> &nbsp;<a class='btn btn-sm btn-danger' onclick="Selecttype();">Reject </a></td>
...
<?php } ?>                                                                        
		 ...
		 <div class="card-body">
		 <form role="form" method="post" action="scripts/reject_access.php" onsubmit="return upperMe1()" enctype="multipart/form-data">
...
$query="SELECT * FROM `bme_access` WHERE  action_by!='' AND action_by IS NOT NULL ";
$result = $link->query($query) or die("Error0 : ".mysqli_error($link));
while($arr=  mysqli_fetch_assoc($result)){ 
$slno=$arr['slno'];
    $associd=$arr['assoc_id'];
 ...
 $Associate_Name=$event_date1['Associate_Name'];
   //location.href='reject_access.php?slno=<?php echo $slno; ?>
                                                                                        <tr>
