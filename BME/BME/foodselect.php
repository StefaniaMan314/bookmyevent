...
<div class="card">
            ...
            <form role="form" method="post" action="food_insert.php?id=<?php echo $event_id; ?>">
            	  <div class="row" >
  <div class="col-lg-1">
  ...
  <div class="col-lg-7">
          ...
          <input type="button"  value="Skip"   class="btn btn-default bg-red"  id="btnHome" onClick="Javascript:window.location.href = 'landing2.php?id=<?php echo $event_id; ?>';" />
            </form>
