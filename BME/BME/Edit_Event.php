    ...
    <div class="card">
        <div class="card-header p-2">
            <ul class="nav nav-pills">
                ...
                <li class="nav-item"><a class="nav-link" href="#upcoming" data-toggle="tab">Title</a></li>
            </ul>
        </div><!-- /.card-header -->
        <div class="card-body">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="nav-tabs-custom">
                            <ul class="nav nav-tabs">
                                ...
                                <li><a href="#timeslot" data-toggle="tab">Timeslot</a></li>
                            ...
                            <div class="tab-content">
                                    ...
                                    <form role="form" id="regForm" method="post" action="UpdateEvent.php?slno=<?php echo $slno; ?>" enctype="multipart/form-data">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <br>
                                                <iframe frameborder="0" scrolling="yes" ; style="overflow:hidden;" src="<?=$file_loc;?>" width="100%" height="150px"> </iframe>
                                            </div>
                                            <div>
                              ...
                              ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select style='font-size:15px;background-color:white;width:40%' oninput="this.className = ''" class="form-control w3-border select2 w3-hover-border-blue" id="golive" oninput="this.className = ''" name='golive' placeholder=" " required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select style='font-size:15px;background-color:white;width:40%' oninput="this.className = ''" class="form-control w3-border select2 w3-hover-border-blue" id="qrcode_status" oninput="this.className = ''" name='qrcode_status' placeholder=" " required>
