    ...
    //Main cal invite for registraion
        ...
        QRcode::png($text, $file, $ecc, $pixel_Size, $frame_size); 
          //echo "Inside function\n";
            ...
            <br/>  
            <br/>  
             You can also cancel this registration, Please click <a href="https://bookmyevent.cerner.com/BME/Profile.php">here</a> 
        <br/>
        <br/>
        Regards,
                    <br/>Cerner Events	</p>';
    ...
    <table bgcolor="#ffffff" cellpadding="0" cellspacing="0" class="nl-container" role="presentation" style="table-layout: fixed; vertical-align: top; min-width: 400px; Margin: 0 auto; border-spacing: 0; border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #ffffff; width: 100%;" valign="top" width="100%">
        ...
        -->
                                            ...
                                            <div align="center" class="img-container center fixedwidth" style="padding-right: 0px;padding-left: 0px;">
                                                ...
                                                <div style="font-size:1px;line-height:20px"> </div><img align="center" alt="Alternate text" border="0" class="center fixedwidth" src="<?php echo $file; ?>" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; width: 100%; max-width: 330px; display: block;" title="Alternate text" width="200" />
                                                <div style="font-size:1px;line-height:20px"> </div>
                                                <p style="font-size: 16px; line-height: 1.5; word-break: break-word;mso-line-height-alt: 24px; margin: 0;"><span style="font-size: 16px;">You can also cancel this registration, Please click <a href="https://bookmyevent.cerner.com/BME/Profile.php">here</a>.</span></p>
                                                <!--[if mso]></td></tr></table><![endif]-->
                                            </div>
                                            <!--[if mso]></td></tr></table><![endif]-->
                                            <!--[if (!mso)&(!IE)]><!-->
                                    ...
                                    <div style="width:100% !important;">
                                        ...
                                        <div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:5px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;">
                                            ...
                                            <div align="center" class="img-container center fixedwidth" style="padding-right: 5px;padding-left: 5px;">
                                                ...
                                                <div style="font-size:1px;line-height:10px"> </div><a href="https://bookmyevent.cerner.com" style="outline:none" tabindex="-1" target="_blank"> <img align="center" alt="Your Logo" border="0" class="center fixedwidth" src="BME_sse.png" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; width: 100%; max-width: 200px; display: block;" title="Your Logo" width="200" /></a>
...
<body style='font-family: Arial, "Helvetica Neue", Helvetica, sans-serif;'>
    <p style='font-size:13px;'>Dear
        <?php echo $assoc_name; ?>,</p>
    <p style='font-size:13px;'>Thank you for registering for
        '<?php echo $event_name; ?>' </p>
    <!-- <h4>Please open the attachment and "Accept" the invite to add it to your calendar.</h4> -->
    <p style='font-size:13px;'>On
        <?php echo $timeslot; ?>
    </p>
    <p style='font-size:13px;'> You are Waitlisted. We will notify you once your registration is confirmed.
    </p>
...
<body style='font-family: Arial, "Helvetica Neue", Helvetica, sans-serif;'>
    <p style='font-size:13px;'>Dear
        <?php echo $assoc_name; ?>,</p>
    <p style='font-size:13px;'>This is a reminder mail for the event -
        <b><?php echo $event_name; ?></b></p>
    <p style='font-size:13px;'>Lets’s meet on
        <?php echo $timeslot; ?>
    </p>

    <p style='font-size:13px;'>Venue:
        <?php echo $location; ?>
    </p>
    <p style='font-size:13px;'> Please carry the below QR code to the event
        <div>
...
<body style='font-family: Arial, "Helvetica Neue", Helvetica, sans-serif;'>
    ...
    <p style='font-size:13px;'>Dear Associate,

        <br />
        <br /><br />
        There are some changes in <?php echo $change_atttribute;  ?> the event <?php echo $event_name;  ?> <br />
        <br />
        <br />
         ...
         // $mail->addCC($manager_email);
          ...
          if(!$mail->send())
          {
            echo "Mailer Error: " . $mail->ErrorInfo;
               ...
               header("location:Profile.php?exist1=Mails sent");
          }
...
<body style='font-family: Arial, "Helvetica Neue", Helvetica, sans-serif;'>
    ...
    <p style='font-size:13px;'>You have requested for accessing and hosting the event in BookMyEvent.
...
<body style='font-family: Arial, "Helvetica Neue", Helvetica, sans-serif;'>
    ...
    <p style='font-size:13px;'>Your request for accesing BookMyEvent application has been Approved.
        <br />
        You can now host the event.
...
<body style='font-family: Arial, "Helvetica Neue", Helvetica, sans-serif;'>
    ...
    <p style='font-size:13px;'>You have requested for accessing a Mailbox in BookMyEvent.

    </p>

    <h5> Associate ID: <?php echo $assoc_id; ?> </h5>
    <h5>Associate Name: <?php echo $assoc_name; ?> </h5>
    <h5>Requested Date: <?php echo $today; ?> </h5>
    <h5>Mailbox: <?php echo $mailbox; ?> </h5>
...
<body style='font-family: Arial, "Helvetica Neue", Helvetica, sans-serif;'>
    ...
    <p style='font-size:13px;'> <?php echo $assoc_name; ?> has requested for accessing a mailbox in BookMyEvent.
    </p>
    ...
    <br />
    Please click <a href="https://bookmyevent.cerner.com/BME/MailboxAction.php">here</a> to approve this request.
    <br />
    <p style='font-size:13px;'>Thanks,
        <br />SSE_ES_DevTeam</p>
    <br />
...
<body style='font-family: Arial, "Helvetica Neue", Helvetica, sans-serif;'>
    ...
    <p style='font-size:13px;'>Your request for accesing Mailbox in BookMyEvent application has been Approved.
        <br />
        <br />
        You can now use the Mailbox in Creating Event.
...
<body style='font-family: Arial, "Helvetica Neue", Helvetica, sans-serif;'>
    ...
    <p style='font-size:13px;'>Your request for accesing Mailbox in BookMyEvent application has been Rejected.
        <br />
        <br />
        <?php echo $Rejectjustification; ?>
