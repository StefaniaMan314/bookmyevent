...
$sql = "Select t.`AssociateID`, t.`AssociateName`, t.`email`, t.`Title`, t.`department`, t.`Organization`,t.`Executive`,CONVERT_TZ(ts.`start`,'+00:00','$offset') AS start,CONVERT_TZ(ts.`end`,'+00:00','$offset') AS end FROM `testevent` t,`timeslot` ts WHERE t.`event`='$event_id' AND t.timeslot=ts.slno";
