...
<div class='section'>
    <div class='row'>
        <?php 
    $query ="SELECT * FROM event WHERE edate >= '$today' AND ename REGEXP '$search_param' AND golive=1 ORDER BY edate ASC ";
 ...
 ?>
        <div class="col-lg-3">
            <a href="Event_Registration.php?id=<?php echo $row['slno']; ?>">
                <div class="card elevation-2" style=" border: 0px solid white;border-radius: 5px ;">
                    ...
                    <div class='row'>
                        <div class="col-lg-12">
                            <h3 title='Not Live' style='color:#0D94D2;font-size:15px;font-weight:bold'><b>&nbsp;<i class="fa fa-circle fa-circle1 fa-beat" style='color:#7BC143;font-size:15px'></i> <?php echo substr($row['ename'],0,35); ?> </b> &nbsp;</h3>
        ...
        <?php 
    $query ="SELECT * FROM event WHERE edate >= '$today' AND ename REGEXP '$search_param' AND golive=0 ORDER BY edate ASC ";
    $result = mysqli_query($connect, $query);
    if(mysqli_num_rows($result) > 0)
    {
     while($row = mysqli_fetch_array($result))
        ...
        <div class="col-lg-3">
            <a href="Event_Registration.php?id=<?php echo $row['slno']; ?>">
                <div class="card elevation-2" style=" border: 0px solid white;border-radius: 5px ;">
                    ...
                    <div class='row'>
                        <div class="col-lg-12">
                            <h3 title='Not Live' style='color:#0D94D2;font-size:15px;font-weight:bold'><b>&nbsp;<i class="fa fa-circle" style='color:#ff0000;font-size:15px'></i> <?php echo substr($row['ename'],0,35); ?> </b> &nbsp;</h3>
                            <h4 style='color:#d1410c;font-size:13px;font-weight:bold '>&nbsp; <b style='color:#0D94D2'>Date:</b> &nbsp; &nbsp; <?php  echo $date11; ?> </h4>
                            <h5 style='color:black;font-size:13px;font-weight:bold '>&nbsp; <b style='color:#0D94D2'> Location: </b>&nbsp; <?php echo substr($row['Location'],0,20);?> - <?php echo $row['country']; ?></h5>
                            <div title='<?php echo $per; ?>% Registrations Complete' class="progress progress-xxs w3-round elevation-1">
                                <div class="progress-bar <?php echo $color_p; ?>" role="progressbar" aria-valuenow=" <?php echo $per; ?>" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $per; ?>%">
