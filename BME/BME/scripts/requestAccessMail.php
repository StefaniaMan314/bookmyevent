...
$result1=$link->query("INSERT INTO `bme_access`(`assoc_id`, `assoc_name`, `assoc_mail`,`from_date`, `to_date`, `justification`,`Organization`,`Requested_On`,`upcoming_events`) VALUES ('$assoc_id','$assoc_name','$assoc_email','$fromdate_final','$todate_final','$justification','$Organization','$today','$eventscount')")  or die("Error test1: ".mysqli_error($link));
